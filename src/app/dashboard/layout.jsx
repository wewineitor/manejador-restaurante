      ...
      <header className={styles.nav}>
        ...
        <nav className={`${styles.menu} ${openMenu ? styles.open_menu : ""}`}>
          ...
          <div className={styles.menu_content}>
            <div
              className={`${styles.icon} ${
                pathname === "/dashboard/empleados" ? styles.page_select : ""
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className={styles.menu_content}>
            <div
              className={`${styles.icon} ${
                pathname === "/dashboard/platillos" ? styles.page_select : ""
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className={styles.menu_content}>
            <div
              className={`${styles.icon} ${
                pathname === "/dashboard/roles" ? styles.page_select : ""
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className={styles.menu_content}>
            <div
              className={`${styles.icon} ${
                pathname === "/dashboard/estadisticas" ? styles.page_select : ""
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className={styles.menu_content}>
            <div
              className={`${styles.icon} ${
                pathname === "/dashboard/cuenta" ? styles.page_select : ""
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
